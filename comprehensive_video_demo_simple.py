...
class VideoSceneManager:
    """Manages different scenes for video demonstration"""
...
class AdaptiveTrafficVideoDemo:
    ...
    def draw_metrics_panel(self):
        ...
        # Draw metrics
        avg_wait = self.metrics.total_wait_time / max(1, self.metrics.vehicles_passed)
        metrics_data = [
            ...
            f"Emergencies Active: {len(self.emergency_system.active_emergencies)}"
        ]
    ...
    def draw_scene_title(self):
        ...
        scene_titles = {
            ...
            'multi_intersection_coordination': ("Network Coordination", "Optimizing traffic across city"),
    ...
    def run(self):
        ...
        print("Starting Adaptive Traffic Video Demo")
        print("=" * 50)
        print("Controls:")
