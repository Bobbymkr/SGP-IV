...
*Status: IN EXECUTION · Created: 2026-08-26 · Last updated: 2026-08-26 (initial)*
...
| 5 Speed | 🔶 partial | — | — | baseline already 57× target → vectorization deferred until eval wall-time demands; ONNX int8/TensorRT adapters pending |
| 6 Graph/docs | ✅ done | 2026-09-03 | `checkpoints/phase6.done` | device-tiers.md added; AGENTS.md verification+dependency rules live |
| T Training pipeline | 🔶 ready (blocked on footage) | 2026-08-26 | — | spec+converter+notebook+OnnxDetector+device.yaml done; dry-run passed; awaiting authority data |
