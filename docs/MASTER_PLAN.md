...
| T Training pipeline | PASS done (finale) | 2026-09-13 | — | **Finale 5-ep joint polish from loop-8 best.pt:** 8-loop chain 0.7949→0.8293 → finale 0.8477 full-10k val (+0.0184, 6-class bicycle 0.6859); low-tier now india-yolov8n-final (fp32 5.1–8.2 fps; static-int8 voided 2026-09-21, see Detector QA in BENCHMARKS.md). Earlier Option A pilot (HeTra mAP50 0.9816) superseded — finale is canonical. Real-data follow-ups: TrafficCAM candidate 0.635 (+30% over finale 0.488 on TrafficCAM val, staged local-only), ITD-X teacher 0.680, pseudo-label pool shipped. |
