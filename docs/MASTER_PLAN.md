...
*Status: IN EXECUTION · Created: 2026-08-26 · Last updated: 2026-09-18 (Steps 0+1)*
...
| 5 Speed | 🔶 partial | — | — | baseline already 57× target → vectorization deferred; Steps 0+1 (2026-09-18): hygiene gate clean (phase6.done added, tool-state ignored, finale docs/scorecards committed), mid/high tiers + all code defaults resolve to india-yolov8n-final (yolov8s artifact never built). Remain: TensorRT fp16 adapter, pipeline decoupling, Prometheus histograms |
