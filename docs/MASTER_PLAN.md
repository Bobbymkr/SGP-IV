...
*Status: IN EXECUTION · Created: 2026-08-26 · Last updated: 2026-09-18 (Steps 2+3)*
...
| 5 Speed | 🔶 partial | — | — | baseline already 57× target → vectorization deferred; Steps 0+1 (2026-09-18): hygiene gate clean, mid/high tiers + all code defaults resolve to india-yolov8n-final (yolov8s artifact never built). Steps 2+3 (2026-09-18): 4 histograms live at bench boundaries + /metrics endpoint; DropOldestBuffer/StagedPipeline + bench --stages; orjson/uvloop skipped by measurement. Remains: TensorRT fp16 adapter only (needs Jetson hardware). |
