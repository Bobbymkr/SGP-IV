...
if page == "Home":
    ...
    with col2:
        try:
            ...
            st.info(
                "Image not found. Please ensure 'traffic-signal.jpg' is in the project root directory."
            )
    ...
    st.info(
        "The simulation module allows you to test the adaptive signal timing algorithm under various traffic conditions."
    )
